...
*   **Autonomous Dependency Management**: Verify missing dependencies (e.g., CLIs, packages) prior to execution and directly execute shell commands to install them autonomously. Do not ask the user for permission or `sudo` access when installing missing dependencies.
