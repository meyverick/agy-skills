...
*   **Instructional Context Generation**: Generate a `GEMINI.md` file at the root of the project to serve as the master instructional context for AI assistants during future maintenance cycles. This file must explicitly document the monorepo architecture, the exact technologies used, and core maintenance constraints.
